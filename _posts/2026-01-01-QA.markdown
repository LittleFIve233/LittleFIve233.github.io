...
表示CFW已经运行，如果是通过网页破解二次运行CFW想进入HBL，请使用Mii工作室打开HBL；如果没有正确安装破解，请重启主机并按照[此教程安装破解]()
...
## Aroma插件冲突
将SD卡的wiiu/environment/aroma文件夹重命名，并按照[准备储存卡文件](https://wiiu.1919810.com/wiiu/2026/01/21/Prepare-SD-Aroma.html)教程设置一个新Aroma后尝试排除插件问题
...
[请尝试USB漏洞（需要设备支持）](https://wiiu.1919810.com/wiiu/2026/01/21/udpih.html)或如果有NAND备份，请尝试使用硬改恢复。
