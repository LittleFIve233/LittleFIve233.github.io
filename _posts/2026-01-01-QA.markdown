...
表示CFW已经运行，如果是通过网页破解二次运行CFW想进入HBL，请使用Mii工作室打开HBL；如果没有正确安装破解，请重启主机并按照[教程安装破解](https://wiiu.1919810.com/wiiu/2026/01/21/Hack-WiiU.html)
...
确保你的SD卡为FAT32格式以及有放入[sigpatches module](https://wiiu.1919810.com/wiiu/2026/01/21/Prepare-SD-Aroma.html)，然后重新插拔一下SD卡并再试一次。
...
## 主机无法更新系统，报错105-3029
主机以前破解做过屏蔽系统更新，[请按照此教程解除屏蔽主机更新](https://wiiu.1919810.com/wiiu/2026/01/21/UDFiine.html)
...
如果重启后不正常请重新放[破解文件](https://wiiu.1919810.com/wiiu/2026/01/21/Prepare-SD-Aroma.html)

## Aroma插件冲突
将SD卡的wiiu/environment/aroma文件夹重命名，并按照[准备储存卡文件](https://wiiu.1919810.com/wiiu/2026/01/21/Prepare-SD-Aroma.html)教程设置一个新Aroma环境后尝试排除插件问题

## 打开浏览器自动卡死或显示DO NOT RUN EXPLOIT TWICE
需要[卸载indexiine](https://wiiu.1919810.com/wiiu/2026/01/21/uninstall-indexiine.html)
...
若在主机闪存中出现的，请尝试初始化主机，若问题依然存在，可能主机闪存的寿命已经到头了
...
**请仅仅修改指定区域的文本，胡乱编辑别的数据可能会引起砖机！请小心再小心**
...
**请确认已经已经认真确定除了game_region type的数值其他与原文件一模一样再替换回去！**

重启主机，打开主机设置选择初始化系统，初始化结束后检查图标是否已经正常。

## 开机直接出现黑屏报错160-0103

系统无法启动默认桌面程序，为常见的CBHC砖机

[请尝试USB漏洞（需要硬件设备支持）](https://wiiu.1919810.com/wiiu/2026/01/21/udpih.html)恢复原数值

**如果是其他开机黑屏报错，请尝试向维修游戏机的师傅寻求帮助**

## 格式化存储卡后无法开机

请检查主机电源灯光颜色，如果为蓝中带紫则代表你安装了isfshax，请寻求他人的帮助解决
