...
## 启动游戏报错199-9999
未检测到SD卡。重新插拔一下SD卡，然后再试一次。请确保你的SD卡为FAT32格式以及有放入sigpatchmodule。如果问题仍然存在，请尝试吹吹卡槽（或尝试其他方法清理），因为可能有一些灰尘积在卡槽里了。
...
~~说了一百遍了别开快速启动菜单怎么就是不听啊！！~~进入主机设置转到电源设置，将待机功能与自动关机功能关闭
...
检查是否有放入sigpatch_module或软件安装包是否完整
