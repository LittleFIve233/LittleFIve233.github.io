...
**DO NOT RUN EXPLOIT TWICE.**：表示TiramisuCFW已经运行，如果想进行安装payloadloader，请重启主机并按照[此教程安装](https://littlefive233.github.io/wiiu/2022/05/27/Hack-Tiramisu.html)
...
**-5**： SD 卡上缺少文件。 检查你 SD 卡上的以下路径中是否存在此 Homebrew Launcher 的文件：/wiiu/apps/homebrew_launcher/homebrew_launcher.elf
...
**使用完vWii Decaffeinator，系统无法更新，一直为最新状态**：系统更新是vWii Decaffeinator的必要，因为Autobooting Tiramisu屏蔽了系统更新，你需要[取消Autobooting Tiramisu](https://littlefive233.github.io/wiiu/2022/05/27/uninstall-PayloadLoader.html#%E5%8F%96%E6%B6%88%E8%87%AA%E5%90%AF%E5%8A%A8tiramisu)，然后再次进行系统更新

**开机黑色闪屏**：与上文的报错199-9999一样，未检查到 SD 卡。

**频道版HBL内任意软件卡死**：

> 请注意：如果你需要[自启动中文系统](https://littlefive233.github.io/wiiu/2022/05/28/install-CHJsystem.html)，请勿执行此步骤
...
这是CBHC的屏蔽更新，只需要[卸载CBHC](https://littlefive233.github.io/wiiu/2022/05/27/uninstall-CBHC.html)即可
...
系统无法启动默认桌面软件，已经砖机...如果有slc的备份，请尝试使用硬改恢复。如果没有，[请尝试USB漏洞（这需要设备支持）](https://littlefive233.github.io/wiiu/2022/05/28/udpih.html)
